...
#include "ballPlay.h"	// class BallPlay
#include "Timekeeper.h"	// class Timekeeper
...
void MainSimulator::registerNewAtomics()
{
	...
	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<Trafico>() , "Trafico" ) ;
  	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<BallPlay>() , "BallPlay" ) ;
  	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<Timekeeper>() , "Timekeeper" ) ;
}
